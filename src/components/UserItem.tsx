    ...
    return (
        <TableRow key={props.user.id}>
            <TableCell style={{width: 100}} align="left">
                <img src={props.user.avatar || noAvatarImg}
                     style={{width: '70px' , height: '70px' , borderRadius: '50%'}} alt='user avatar'/>
            </TableCell>
            ...
            <TableCell style={{width: 20}} align='left'>
                <IconButton aria-label="delete" size='small' sx={{mt: 0.2 , mb: 0.2 , display: 'block' , width: 0}}
                            onClick={() => deleteUserHandler(props.user.id)} disabled={status==='loading'}>
                    <DeleteIcon/>
                </IconButton>
